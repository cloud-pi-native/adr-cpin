...
Cette ADR propose une série de patrons d’architecture spécialement conçus pour les applications asynchrones déployées sur Kubernetes. Avant cela, il est important de comprendre pourquoi l’asynchronisme est souvent indispensable dans ce contexte.
...
- Les modules "Service Front-End" et "Service Notification" peuvent être  développé dans plusieurs langages, par exemple Python. 
